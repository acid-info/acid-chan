            ...
            <AboutContent>
              <div id='content'>
                <p>
                  ...
                  The working technology comes in part from the <a href='https://logos.co/technology' target='_blank' rel='noreferrer'> Logos Technology Stack </a> {' '} protocols using Waku and Codex. it's all text including links from which media is embedded, shared peer-to-peer. Users do not need to register an account before participating in the community. Feel free to click on a tab below that interests you and jump right in!{' '}
                </p>
                <br />
